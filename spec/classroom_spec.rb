...
describe Classroom do
  before(:each) do
    ...
    @student = Student.new(age: 30, classroom: @classroom.label, name: 'Francis', parent_permission: false)
  end
  ...
  it 'checks the size of students array' do
    @student1 = Student.new(age: 24, classroom: @classroom.label, name: 'Lily', parent_permission: true)
    @classroom.add_student(@student)
